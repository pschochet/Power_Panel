# This program was updated in January 2024 to allow for 1 cluster
# for the analysis (before there needed to be at least 2 treatment and 2
# comparison clusters per time period)
